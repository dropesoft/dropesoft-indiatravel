...
/**
 * Test case for class \Dropesoft\Indiatravel\Domain\Model\AttractionType.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class AttractionTypeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Dropesoft\Indiatravel\Domain\Model\AttractionType
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Dropesoft\Indiatravel\Domain\Model\AttractionType();
	}
