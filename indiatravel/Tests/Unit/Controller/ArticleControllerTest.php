...
/**
 * Test case for class Dropesoft\Indiatravel\Controller\ArticleController.
 *
 */
class ArticleControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dropesoft\Indiatravel\Controller\ArticleController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dropesoft\\Indiatravel\\Controller\\ArticleController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllArticlesFromRepositoryAndAssignsThemToView()
	{
		...
		$articleRepository = $this->getMock('', array('findAll'), array(), '', FALSE);
