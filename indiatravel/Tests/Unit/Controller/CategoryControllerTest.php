...
/**
 * Test case for class Dropesoft\Indiatravel\Controller\CategoryController.
 *
 */
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dropesoft\Indiatravel\Controller\CategoryController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dropesoft\\Indiatravel\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	{
		$category = new \Dropesoft\Indiatravel\Domain\Model\Category();
